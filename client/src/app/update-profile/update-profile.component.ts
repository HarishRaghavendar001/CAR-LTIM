...
export class UpdateProfileComponent implements OnInit {
  ...
  showPasswordModal = false; // controls modal visibility
  ...
  openPasswordModal() {
    this.showPasswordModal = true; // hide update form
  }

  // Close Change Password Modal
  closePasswordModal() {
    this.showPasswordModal = false; // show update form again
  }
    ...
    if (this.passwordForm.valid) {
      ...
      this.httpService.changePassword(endpoint, this.passwordForm.value, headers).subscribe({
        next: (res: any) => {
          ...
          this.closePasswordModal(); // show update profile form again
        },
        error: (err) => {
